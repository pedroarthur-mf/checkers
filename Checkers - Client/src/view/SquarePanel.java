...
public class SquarePanel extends JPanel {
	...
	class MouseHandler extends MouseAdapter {
		...
		public void mousePressed(MouseEvent e) {
			/*
			 * if(isClicked()){ System.out.println("deselect - "+square.getSquareID());
			 * resetClicked(); repaint(); } else
			 * if(square.getPlayerID()==SessionVariable.myID.getValue()){
			 * System.out.println("select - "+square.getSquareID()); setClicked();
			 * repaint(); }
			 */
		}
	}
