...
public class SquarePanel extends JPanel {
	...
	private /*@ spec_public nullable @*/ Border defaultBorder = BorderFactory.createEtchedBorder(WHEN_FOCUSED, Color.black, Color.gray);
	//private Border focusedBorder = BorderFactory.createEtchedBorder(WHEN_FOCUSED, Color.white, Color.gray);
	private /*@ spec_public nullable @*/ Border thickBorder = BorderFactory.createLineBorder(Colors.PURPLE.getColor(),5);
