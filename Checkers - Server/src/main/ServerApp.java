...
public class ServerApp extends JFrame {
	...
	//Frame components
	private /*@ spec_public nullable @*/ JScrollPane scroll;
	private /*@ spec_public nullable @*/ JTextArea information;
	private /*@ spec_public nullable @*/ JLabel title;
	
	//Network properties
	private /*@ spec_public nullable @*/ ServerSocket serverSocket;
	int sessionNo;
